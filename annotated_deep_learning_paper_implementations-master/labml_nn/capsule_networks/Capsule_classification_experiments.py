"""
title: classification of fake images (easy/mid/hard/real) with Capsule Networks
...
from fake_classification_easy_mid_hard_real_dataset import Easy_mid_hard_real_classification_Configs, IMG_SIZE
...
class CapsuleNetworkModel(Module):
    ...
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(in_channels=256, out_channels=8 * 8, kernel_size=9, stride=2, padding=0)
        self.squash = Squash()
        ...
        self.digit_capsules = Router(8 * out_size * out_size, NUM_OF_OUTPUT_CAPSULS, 8, 16, 3)
        # self.digit_capsules = Router(32 * out_size * out_size, NUM_OF_OUTPUT_CAPSULS, 8, 16, 3)
...
class Configs(Easy_mid_hard_real_classification_Configs, SimpleTrainValidConfigs):
    """
...
def main():
    ...
    experiment.create(name='capsule_classification_network')
